...
plot "1kb.dat" using 1:2 title "libcmalloc" with linespoints ls 1, \
"1kb.dat" using 1:3 title "jemalloc" with linespoints ls 2, \
"1kb.dat" using 1:4 title "tcmalloc" with linespoints ls 3
